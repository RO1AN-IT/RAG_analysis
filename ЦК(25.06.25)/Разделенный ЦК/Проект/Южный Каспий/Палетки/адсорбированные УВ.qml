...
<qgis styleCategories="AllStyleCategories" minScale="1e+08" maxScale="0" hasScaleBasedVisibilityFlag="0" version="3.22.16-Białowieża">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" band="1" type="singlebandpseudocolor" classificationMax="0.6436" opacity="1" alphaBand="-1" classificationMin="0">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader maximumValue="0.64359999999999995" colorRampType="INTERPOLATED" clip="0" minimumValue="0" classificationMode="3" labelPrecision="4">
          <colorramp type="gradient" name="[source]">
            <Option type="Map">
              ...
              <Option value="0.25;41,115,190,255:0.5;24,189,117,255:0.75;35,224,60,255" type="QString" name="stops"/>
            </Option>
            <prop k="color1" v="230,230,230,255"/>
            <prop k="color2" v="239,227,0,255"/>
            <prop k="discrete" v="0"/>
            <prop k="rampType" v="gradient"/>
            <prop k="stops" v="0.25;41,115,190,255:0.5;24,189,117,255:0.75;35,224,60,255"/>
          </colorramp>
          <item label="0,00" color="#e6e6e6" value="0" alpha="255"/>
          <item label="0,16" color="#2973be" value="0.1609" alpha="255"/>
          <item label="0,32" color="#18bd75" value="0.3218" alpha="255"/>
          <item label="0,48" color="#23e03c" value="0.4827" alpha="255"/>
          <item label="0,64" color="#efe300" value="0.6436" alpha="255"/>
