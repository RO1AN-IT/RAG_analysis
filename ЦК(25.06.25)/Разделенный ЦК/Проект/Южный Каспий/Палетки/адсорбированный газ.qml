...
<qgis styleCategories="AllStyleCategories" minScale="1e+08" maxScale="0" hasScaleBasedVisibilityFlag="0" version="3.22.16-Białowieża">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" band="1" type="singlebandpseudocolor" classificationMax="0.0769984593837535" opacity="1" alphaBand="-1" classificationMin="0">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader maximumValue="0.076998459383753506" colorRampType="INTERPOLATED" clip="0" minimumValue="0" classificationMode="3" labelPrecision="4">
          ...
          <item label="0,02" color="#2973be" value="0.01925" alpha="255"/>
          <item label="0,04" color="#18bd75" value="0.0385" alpha="255"/>
          <item label="0,06" color="#23e03c" value="0.05775" alpha="255"/>
          <item label="0,08" color="#efe300" value="0.0769984593837535" alpha="255"/>
