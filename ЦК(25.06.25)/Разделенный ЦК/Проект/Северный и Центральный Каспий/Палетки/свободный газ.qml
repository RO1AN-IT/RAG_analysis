...
<qgis styleCategories="AllStyleCategories" minScale="1e+08" maxScale="0" hasScaleBasedVisibilityFlag="0" version="3.22.16-Białowieża">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" band="1" type="singlebandpseudocolor" classificationMax="2.2506" opacity="1" alphaBand="-1" classificationMin="0">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader maximumValue="2.2505999999999999" colorRampType="INTERPOLATED" clip="0" minimumValue="0" classificationMode="2" labelPrecision="2">
          ...
          <item label="0,56" color="#a3b4ee" value="0.56265" alpha="255"/>
          <item label="1,13" color="#7c97dd" value="1.1253" alpha="255"/>
          <item label="1,69" color="#5679cb" value="1.68795" alpha="255"/>
          <item label="2,25" color="#2f5bba" value="2.2506" alpha="255"/>
